...
export default function TicTacToe() {
  ...
  const gameStatus = winner? "Winner: " + winner : "Next player: " + (xIsNext ? "X" : "O");

  /**
   *  function handles the click of the ith square
  ...
  function buildBoard(){
    const gameBoard = [];
    //gameBoard.push(<div className='status'>{gameStatus}</div>);
...
/*
  ...
  value: 'X' or 'O'
  onSquareClick: the function to call when the square is clicked
*/
